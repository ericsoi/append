...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2023 at 12:13 PM
...
INSERT INTO `borrower` (`borrower_id`, `firstname`, `middlename`, `lastname`, `contact_no`, `address`, `email`, `tax_id`, `id_doc`, `signature_doc`) VALUES
(9, 'Mercy', 'Mutheu', 'Ngumbau', '07123123123', 'Kenuaqw', '07123123123', '3990998', 'C:/xampp/htdocs/Append/uploads/07123123123/id_doc_1012430_625203190929718_1173057093242330248_n.jpg_Splitter_C:/xampp/htdocs/Append/uploads/07123123123/id_doc_back_different-lot-types-babypips.png', 'C:/xampp/htdocs/Append/uploads/07123123123/signature_doc_F7TDfSRXAAA4Y6k.jpeg');
...
CREATE TABLE `loan` (
  ...
  `loan_form` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
ALTER TABLE `loan_schedule`
  MODIFY `loan_sched_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=352;
